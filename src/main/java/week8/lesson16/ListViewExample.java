...
public class ListViewExample extends Application {
	...
	public void start(Stage primaryStage) {
		...
		final ObservableList<String> lefts = FXCollections.observableArrayList(
				"A", "B", "C");
		...
		final ObservableList<String> rights = FXCollections
				.observableArrayList();
		...
		sendRightButton.setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent event) {
				String item = leftListView.getSelectionModel()
						.getSelectedItem();
				if (item != null) {
		...
		sendLeftButton.setOnAction(new EventHandler<ActionEvent>() {
			@Override
			public void handle(ActionEvent event) {
				String item = rightListView.getSelectionModel()
						.getSelectedItem();
				if (item != null) {
