...
public class DoublyLinkList {
	...
	public void delete(int inx) {
		...
		else System.out.println("индекс элемента больше размера списка.");
	}
	...
	public DNode getElement(int inx) {
		...
		if (k != inx) {
			System.out.println("\nэлемент с индексом [" + inx + "] не найден");
			return null;
		}
		else return cur;
	}
	...
	public void swapElem(int inx1, int inx2) {
		...
		if (k != inx1) {
			System.out.println("\nэлемент с индексом [" + inx1 + "] не найден");
			return;
		}
		DNode e1 = cur;
		...
		if (k != inx2) {
			System.out.println("\nэлемент с индексом [" + inx2 + "] не найден");
			return;
		}
		DNode e2 = cur;
