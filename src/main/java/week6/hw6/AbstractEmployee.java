...
public abstract class AbstractEmployee implements Comparable<AbstractEmployee>,
	...
	private double				salary;			// ставка
	private double				salaryAcc;			// рахунок заплатний
	private double				seniority;			// стаж
	private double				vacationDays;		// кількість нарах. днів
	// відпустки
	private GregorianCalendar	dateOfLastVacation;
	private String				deptName;
	private double				salaryToHandIn;	// до видачі в поточному
